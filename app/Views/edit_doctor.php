...
<div class="container myDiv">
    <h1 class="text-primary text-center">EDIT DOCTOR</h1>
    <form action="/updateDoctor" method="post" class="row g-3 p-4">
        ...
        <div class="col-md-6">
            ...
            <input type="password" id="password" name="password" class="form-control" value="<?= $doctor['password'] ?>" required>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" id="address" name="address" class="form-control" value="<?= $doctor['address'] ?>" required>
        </div>
        ...
        <div class="col-12 text-center">
            <button type="submit" class="btn btn-primary btn-update" onclick="showAlert()">Update Doctor</button>
        </div>
    </form>
</div>
